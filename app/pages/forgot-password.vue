    ...
    :ui="{ overlay: 'bg-default' }" >
      <template #content>
        <div class="flex flex-col justify-center items-center">
          ...
          <p class="text-xl font-bold pb-2">Reset Password</p>
          <p class="pb-8">Enter the email address of your account</p>
          <UForm
            ref="form"
            :state="state"
            :schema="resetSchema"
          ...
          >
            <div>
              <UFormField name="email" label="Your Email">
                <UInput 
                  v-model="state.email" 
            ...
            <div class="pt-6 text-center">
              <UButton :loading="loading" type="submit">Send a password reset link</UButton>
            </div>
          </UForm>
        </div>  
      </template>
