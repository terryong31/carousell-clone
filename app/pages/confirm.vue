...
<template>
  <UModal :dismissible="false" :open="true">
    <template #content>
      <div v-if="status === 'loading'" class="flex flex-col items-center justify-center py-20 gap-4">
          <UIcon name="i-lucide-loader" class="size-8 animate-spin text-primary" />
          <p>Confirming your account... please wait.</p>
      </div>

      <div v-if="status === 'success'" class="flex flex-col items-center justify-center py-20 gap-4">
